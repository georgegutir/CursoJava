package jpa.ejemplojpa;

import java.time.LocalDate;

import jpa.ejemplojpa.accesodatos.AccesoDatosException;
import jpa.ejemplojpa.accesodatos.ClienteJpaDao;
import jpa.ejemplojpa.accesodatos.Dao;
import jpa.ejemplojpa.entidades.Cliente;
